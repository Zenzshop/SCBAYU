...
global.reloadHandler = function () {
  ...
  conn.welcome = 'Hai welcome kontol baca deks jangan share link dek, @user!\nSelamat datang di grup jangan lupa baca deks ya bocil epep @subject\n\n@desc'
  conn.bye = 'Selamat tinggal ya kontol jangan balik lagi yah ngentot lu asw memek @user!'
